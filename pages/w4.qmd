...
$P(t)$ may have various conditions connected by logical connectives like AND ($\land$), OR ($\lor$), and NOT ($\lnot$).

It also uses quantifiers:
$\exists t \in r(Q(t)) =$ "there exists" a tuple $t$ in relation $r$ such that $Q(t)$ is true.
$\forall t \in r(Q(t)) =$ "for all" tuples $t$ in relation $r$, $Q(t)$ is true.
